...
## HW10 - Ansible роли, управление настройками нескольких окружений и best practices 

Использование директории ansible внутри проекта infra.

- перенести созданные плейбуки в раздельные роли

- описать два окружения

- использовать коммьюнити роль nginx

- использовать Ansible Vault для наших окружений
